...
const StorySection = () => {
    return (
                ...
                }}     className="text-black  dark:bg-backgroundDark   dark:text-textDark  bg-white px-4 rounded-lg font-sans shadow-lg shadow-primary font-bold text-[50px] md:text-[56px] lg:text-[40px] xl:text-[50px] xl:whitespace-nowrap ">
      ...
      <div className="mt-[100px] flex justify-center items-center">
        <div className="text-black dark:bg-backgroundDark   dark:text-textDark  bg-white px-5 py-5 rounded-lg shadow-xl shadow-purple-400  grid grid-cols-1 sm:grid-cols-2 gap-4 w-full xl:max-w-6xl  2xl:max-w-7xl"> 
          <div className="flex justify-center items-center rounded-lg font-sans text-[20px] md:text-[23px] xl:text-[30px] py-2">
            <p className=''> <span className='bg-[#FF000D] py-1 rounded-md px-2 text-white'>Vishal</span> runs a small business that he’s been doing for years. He has loyal customers who visit 
                ...
                outside his area, and despite his hard work, he finds it <span className="bg-[#FFFF00]  dark:text-black  px-3 ">hard to grow</span> past a certain point
