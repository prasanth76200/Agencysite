        ...
        <nav
            ...
            <div className="">
                ...
                <a
                    ...
                    <span
                    className="absolute left-1/2 bottom-0 transform -translate-x-1/2 w-0 h-0 rounded-full border-2 border-white opacity-0 transition-all duration-300 group-hover:w-[120px] group-hover:h-10 group-hover:opacity-100"
                    ></span>
                </a>
                </li>
                <li>
                <a
                    ...
                    <span
                    className="absolute left-1/2 bottom-0 transform -translate-x-1/2 w-0 h-0 rounded-full border-2 border-white opacity-0 transition-all duration-300 group-hover:w-[70px] group-hover:h-9 group-hover:opacity-100"
                    ></span>
                </a>
                </li>
