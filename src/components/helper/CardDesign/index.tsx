interface CardDesignProps {
  ...
  const CardDesign: React.FC<CardDesignProps> = ({ headLine, words, img, imgSrc ,width}) => {
    return (
      <div>
        <div className="relative mt-10 flex w-80 flex-col rounded-xl bg-gradient-to-br from-white to-gray-50 bg-clip-border text-gray-700 shadow-lg hover:shadow-md hover:shadow-secondary transition-all duration-300 hover:-translate-y-1">
          ...
          <div className="p-6">
            <h5 className="mb-2 block font-sans whitespace-nowrap text-center text-xl font-semibold leading-snug tracking-normal text-gray-900 antialiased group-hover:text-blue-600 transition-colors duration-300">
              {headLine}
            </h5>
