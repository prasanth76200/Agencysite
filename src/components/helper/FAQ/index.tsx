...
const tabs = [
  {
    ...
    description:
      'Our pricing depends on the project’s scope and complexity. Contact us prasanth76200@gmail.com for a free consultation to discuss your needs.',
  ...
  },
  {
    ...
    description:
      'Yes, we provide ongoing support and maintenance to ensure your application remains up-to-date and performs optimallyYes, we p-friendly designs to ensure an optimal user experience on all devices.',
  ...
  return (
    <>
      <div className='container mx-auto pb-10 pt-2'>
        ...
        <div className='h-fit border  shadow-xl  shadow-purple-400  rounded-lg p-2 border-6 border-black dark:bg-[#111111] bg-[#ffffff]'>
          {tabs.map((tab, index) => (
            <motion.div
              key={index}
